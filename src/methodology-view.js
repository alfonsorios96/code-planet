...
class MethodologyView extends PolymerElement {
  static get template() {
    return html`
      ...
      <div class="card">
        <h2>Metodología</h2>
        <blackquote>
            Transmitir los conocimientos no es cuestión tan sencilla, de hecho, es una labor bastante compleja en temas de didáctica y por lo mismo, tenemos un compromiso con el impacto real que estamos brindando y nos ocupamos en el cómo.
        </blackquote>
       </div>
       <div class="card">
       <h2>Las clases</h2>
          ...
          <ul>
              ...
              <li>Las clases se realizan en días sábados por la mañana a partir de las 10h00. Y los domingos cuentas con 1hora de asesoramiento personalizado entre las 10h00 y las 13h00 por módulo. Esto en modalidad remota por Hangouts</li>
          </ul>
        </blackquote>
      </div>
      <div class="card">
 ...
 <div class="card">
      <h2>Pagos</h2>
        ...
        <blackquote>
            <ul>
                <li>En esta modalidad existe un concepto de <b>inscripción</b> que tiene un costo de $2,000 y con este pago único, te puedes inscribir a los módulos que desees.</li>
                ...
                <li>El pago de un módulo se realiza en dos pagos quincenales, uno antes de la fecha del curso y la otra parte puede ser después.</li>
